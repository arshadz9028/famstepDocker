...
function DesignationModel({ setDesignationModel }) {
  const { selectedDesignation, setSelectedDesignation } =
    useContext(ContextProvider);
  const [selectDesignation, setSelectDesignation] =
    useState(selectedDesignation);
  ...
  const filteredLanguages = designationJson.filter((option) =>
    option.designation.toLowerCase().startsWith(selectDesignation.toLowerCase())
  );
