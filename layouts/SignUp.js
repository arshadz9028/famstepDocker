...
import { ragisterValidate } from "../lib/validate";
  ...
  async function onSubmit(values) {
    try {
      ...
      if (response.data.success === "success") {
        // Store the auth token in sessionStorage instead of the password
          ...
          <div className={styles.signup_form}>
            ...
            <div>
              <div className={styles.login_title}>
                <span className={styles.join_famstep}> Join Famstep </span>
                <span className={styles.or}>
                  or
                  <Link href="/login">
                    <span className={styles.my_link}> sign in</span>
                  </Link>
                </span>
              </div>
              <form onSubmit={formik.handleSubmit} autoComplete="off">
                ...
                <div className={styles.passInput_icon}>
                  ...
                  <div
                    className={styles.passwordIcons_cover}
                ...
                <p className={styles.minusAgree}>
                  <span className={styles.agree}>
                    By signing up, you agree to the Famstep{" "}
                    <Link href="/">
                      <span className={styles.my_link}>User Agreement, </span>
                    </Link>
                    <Link href="/">
                      <span className={styles.my_link}>Privacy Policy,</span>
                    </Link>{" "}
                    and{" "}
                    <Link href="/">
                      <span className={styles.my_link}> Cookie Policy.</span>
                    </Link>
                  </span>
                </p>
