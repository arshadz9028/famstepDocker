...
function UserAgreement({session}) {
  return (
    <>
      ...
      <div className={styles.main}>
        <div className={styles.center}>
          <div className={styles.upperSection}>
            <h2 className={styles.main_header1}>USERS AGREEMENT</h2>
            <p className={styles.subtitle}>Last updated September 04, 2024</p>
          </div>

          <div className={styles.upperSection}>
            <h2 className={styles.main_header}>AGREEMENT TO OUR LEGAL TERMS</h2>

            <p className={styles.content}>
              We are FAMSTEP PRIVATE LIMITED (
              <strong>&ldquo;we,&ldquo; &ldquo;us,&ldquo;</strong> or
              <strong> &ldquo;our&ldquo;</strong>), a company registered in
              India at Safiya Bldg, R No 2, Bombay Colny, Diva, Mumbra, Thane,
            ...
            <p className={styles.content}>
              ...
              >
                https://www.famstep.com
              </a>{" "}
              (the <strong>&ldquo;Site&ldquo;</strong>), the mobile application
              famstep (the <strong>&ldquo;App&ldquo;</strong>), as well as any
              other related products and services that refer or link to these
              legal terms (the <strong>&ldquo;Legal Terms&ldquo;</strong>)
              (collectively, the <strong>&ldquo;Services&ldquo;</strong>).
            </p>
            <p className={styles.content}>
              A platform designed for users to showcase their talents. While
              many existing websites offer motivation, competitions, job
              listings, and freelancing opportunities, they typically focus on
              one specific area. Our primary goal is to provide a comprehensive
              platform where users can register and embark on a journey of skill
              enhancement from start to finish, gradually becoming more talented
              individuals day by day
            </p>
            <p className={styles.content}>
              You can contact us by phone at 96195 27143, email at
              contact@famstep.com, or by mail to Safiya Bldg, R No 2, Bombay
              Colny, Diva, Mumbra, Thane, THANE, MAHARASHTRA 400612, India.
            </p>
            <p className={styles.content}>
              These Legal Terms constitute a legally binding agreement made
              between you, whether personally or on behalf of an entity (
              <strong>&ldquo;you</strong>&ldquo;), and FAMSTEP PRIVATE LIMITED,
          ...
          <div className={styles.upperSection}>
            <h2 className={styles.main_header}>1. OUR SERVICES</h2>
            <p className={styles.content}>
          ...
          <div className={styles.upperSection} id="personalinfo">
            ...
            <p className={styles.subtitleHigh}>Our intellectual property</p>
            <p className={styles.content}>
            ...
            <p className={styles.subtitleHigh}>Your use of our Services</p>
            <p className={styles.content}>
              Subject to your compliance with these Legal Terms, including the
              &nbsp;&quot;
              <a href="#PROHIBITED" rel="noopener noreferrer">
            ...
            <p className={styles.content}>
              ...
              Terms, please address your request to: contact@famstep.com. If we
            ...
            <p className={styles.subtitleHigh}>Copyright infringement</p>
            ...
            <p className={styles.content}>
              ...
              <a href="#copyright" rel="noopener noreferrer">
          ...
          <div className={styles.upperSection} id="personalinfo1">
            <h2 className={styles.main_header}>3. USER REPRESENTATIONS</h2>
            <p className={styles.content}>
          ...
          <div className={styles.upperSection}>
            <h2 className={styles.main_header}>4. USER REGISTRATION</h2>
          ...
          <div className={styles.upperSection} id="personalinfo3">
            <h2 className={styles.main_header}>5. PURCHASES AND PAYMENT</h2>
          ...
          <div className={styles.upperSection} id="personalinfo2">
            <h2 className={styles.main_header}>6. SUBSCRIPTIONS</h2>

            <p className={styles.subtitleHigh}>Billing and Renewal</p>
            <p className={styles.content}>
            ...
            <p className={styles.subtitleHigh}>Free Trial</p>
            <p className={styles.content}>
            ...
            <p className={styles.subtitleHigh}>Cancellation</p>
            <p className={styles.content}>
            ...
            <p className={styles.subtitleHigh}>Fee Changes</p>
            <p className={styles.content}>
          ...
          <div className={styles.upperSection}>
            <h2 className={styles.main_header}>7. SOFTWARE</h2>
          ...
          <div className={styles.upperSection} id="PROHIBITED">
            <h2 className={styles.main_header}>8. PROHIBITED ACTIVITIES</h2>
          ...
          <div className={styles.upperSection}>
            <h2 className={styles.main_header}>10. CONTRIBUTION LICENSE</h2>
            <p className={styles.content}>
          ...
          <div className={styles.upperSection}>
            <h2 className={styles.main_header}>11. GUIDELINES FOR REVIEWS</h2>
          ...
          <div className={styles.upperSection} id="personalinfo4">
            ...
            <p className={styles.subtitleHigh}>Use License</p>
            <p className={styles.content}>
            ...
            <p className={styles.subtitleHigh}>Apple and Android Devices</p>
            <p className={styles.content}>
          ...
          <div className={styles.upperSection}>
            <h2 className={styles.main_header}>13. SOCIAL MEDIA</h2>
          ...
          <div className={styles.upperSection}>
            <h2 className={styles.main_header}>15. SERVICES MANAGEMENT</h2>
          ...
          <div className={styles.upperSection} id="contactInfo">
            <h2 className={styles.main_header}>16. PRIVACY POLICY</h2>
          ...
          <div className={styles.upperSection} id="copyright">
            <h2 className={styles.main_header}>17. COPYRIGHT INFRINGEMENTS</h2>
            <p className={styles.content}>
              We respect the intellectual property rights of others. If you
              believe that any material available on or through the Services
              infringes upon any copyright you own or control, please
          ...
          <div className={styles.upperSection} >
            <h2 className={styles.main_header}>18. TERM AND TERMINATION</h2>
            <p className={styles.content}>
          ...
          <div className={styles.upperSection} id="deleteInfo">
            <h2 className={styles.main_header}>20. GOVERNING LAW</h2>
            <p className={styles.content}>
              These Legal Terms shall be governed by and defined following the
              laws of India. FAMSTEP PRIVATE LIMITED and yourself irrevocably
          ...
          <div className={styles.upperSection} id="deleteInfo">
            <h2 className={styles.main_header}>21. DISPUTE RESOLUTION</h2>
            <p className={styles.content}>
              ...
              Terms to the jurisdiction of the India courts. FAMSTEP PRIVATE
              LIMITED shall also maintain the right to bring proceedings as to
              the substance of the matter in the courts of the country where you
          ...
          <div className={styles.upperSection} id="deleteInfo">
            <h2 className={styles.main_header}>22. CORRECTIONS</h2>
            <p className={styles.content}>
          ...
          <div className={styles.upperSection} id="deleteInfo">
            <h2 className={styles.main_header}>23. DISCLAIMER</h2>
            <p className={styles.content}>
          ...
          <div className={styles.upperSection} >
            <h2 className={styles.main_header}>24. LIMITATIONS OF LIABILITY</h2>
            <p className={styles.content}>
              ...
              PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR 1000000000. CERTAIN
          ...
          <div className={styles.upperSection} >
            <h2 className={styles.main_header}>25. INDEMNIFICATION</h2>
            <p className={styles.content}>
          ...
          <div className={styles.upperSection} id="deleteInfo">
            <h2 className={styles.main_header}>26. USER DATA</h2>
            <p className={styles.content}>
          ...
          <div className={styles.upperSection} id="deleteInfo">
            <h2 className={styles.main_header}>29. MISCELLANEOUS</h2>
            <p className={styles.content}>
          ...
          <div className={styles.upperSection} id="deleteInfo">
            <h2 className={styles.main_header}>30. CONTACT US</h2>
            <p className={styles.content}>
